...
if(isset($_POST[submit]))
{
	...
	{
			$sql ="UPDATE chw SET chwname='$_POST[chwname]',loginid='$_POST[loginid]',password='$_POST[password]',status='$_POST[select]' WHERE chwidid='$_GET[editid]'";
	...
	{
	$sql ="INSERT INTO chw(chwname,loginid,password,status) values('$_POST[chwname]','$_POST[loginid]','$_POST[password]','Active')";
	if($qsql = mysqli_query($con,$sql))
	{
...
if(isset($_GET[editid]))
{
	$sql="SELECT * FROM chw WHERE chwid='$_GET[editid]' ";
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Add New chw </li></ul>
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
    <h1>Add new chw record</h1>
...
{
	if(document.frmdoct.chwname.value == "")
	{
		alert("Doctor name should not be empty..");
		document.frmdoct.doctorname.focus();
		return false;
	}
	else if(!document.frmdoct.chwname.value.match(alphaspaceExp))
	{
