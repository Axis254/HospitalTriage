...
{
	echo "<script>window.location='chwaccount.php';</script>";
}
if(isset($_POST[submit]))
{
	$sql = "SELECT * FROM chw WHERE loginid='$_POST[loginid]' AND password='$_POST[password]' AND status='Active'";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_num_rows($qsql) == 1)
	{
		$rslogin = mysqli_fetch_array($qsql);
		$_SESSION[chwid]= $rslogin[chwid] ;
		echo "<script>window.location='chwaccount.php';</script>";
	}
	else
	{
...
<html lang="en">
  <head>
  <title>CHW Login | Triage System</title>
<meta charset="UTF-8">
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">chw Login Panel</li></ul>
  </div>
</div>
<div class="wrapper col4">
  <div id="container">
    <h1 align="center">Kindly enter Login ID and Password</h1>
