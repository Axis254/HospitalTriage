...
--
-- Database: `onlineTriagemanagementsystem`
--
...
(20, 'Physiotherapy', 'Includes services to specialized clinic inpatients who are referred by Triage physicians or primary health care clinics.', 'Active');
...
--
-- Table structure for table `chw`
--

CREATE TABLE `chw` (
  `chwid` int(11) NOT NULL,
  `chwname` varchar(100) NOT NULL,
...
--
-- Dumping data for table `chw`
--

INSERT INTO `chw` (`chwid`, `chwname`, `loginid`, `password`, `status`) VALUES
...
--
-- Indexes for table `chw`
--
ALTER TABLE `chw`
  ADD PRIMARY KEY (`chwid`);
...
--
-- AUTO_INCREMENT for table `chw`
--
ALTER TABLE `chw`
  MODIFY `chwid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
